...
public class GerhardtSchusterTyson {
    ...
    // --- for question 5: to summerise wave propagation speed, shape of wave, spiral identities( gaps - number of waves, stability, circle?)? with spiral (initial code), or one excited corner (edited code) ??? 
